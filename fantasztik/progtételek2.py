...
*Egy sorozathoz egy értéket rendelő algoritmusok​
    ...
    Maximum kiválasztás​
    Minimum kiválasztás​
*Egy sorozathoz egy sorozatot rendelő algoritmusok​ másolás,kiválogatás,rendezés
*Több sorozathoz egy sorozatot rendelő algoritmusok​,unio,kulonbseg,metszet
*Egy sorozathoz több sorozatot rendelő algoritmusok​,szetvalogatas
buborek rendezes
